...
const Ai: React.FC = () => {
  ...
  const tags = ['Frontend', 'Easy', 'Knowledge'];
            ...
            <div className="bg-white rounded-5 shadow-sm border border-slate-200 p-4 p-xl-5">
              ...
              <div className="d-flex flex-column gap-3">
                {options.map((option) => (
                  <label
                    key={option.id}
                    className={`d-flex align-items-center p-4 rounded-4 border-2 cursor-pointer transition ${selectedAnswer === option.id
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-4 p-3 d-flex gap-3 align-items-start mt-4">
                ...
                <div>
                  ...
                  <p className="text-blue-800 small mb-0">Bootstrap is a popular CSS framework for responsive design</p>
                </div>
              </div>
            </div>
