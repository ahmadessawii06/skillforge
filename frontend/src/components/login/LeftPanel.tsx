    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                color: "white", maxWidth: "34rem", width: "100%",
                ...
                <h2 style={{ fontWeight: 900, lineHeight: 1.2, marginBottom: "1.5rem", fontSize: "2.5rem" }}>
                    Master your next big career move.
                </h2>

                <p style={{ fontSize: "1rem", lineHeight: 1.75, color: "rgba(255,255,255,0.9)", marginBottom: "2.5rem" }}>
                    Practice with our advanced AI interviewers and get real-time feedback
                    on your performance, body language, and content.
                </p>

                {features.map((feature) => (
                    <div key={feature} style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "1.25rem" }}>
                        <div style={{
